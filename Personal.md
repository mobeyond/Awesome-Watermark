Due respect to all contributors list or unlisted here, I'd like to recommend only 1 formal python project which can be installed directly by one command:
